...
export default function Home() {
    return (
        <>
            <div className="pt-24">
                <div className="lg:flex px-10 items-center justify-between">
                    <div className="lg:w-1/2 w-full">
                        <h1 role="heading" className="md:text-5xl text-3xl font-bold leading-10 mt-3 text-gray-800">Why seek career guidance after graduation or just before?</h1>
                    ...
                    <div className="xl:w-1/2 lg:w-7/12 relative w-full lg:mt-0 mt-12 md:px-8" role="list">
                        ...
                        <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg mt-3 flex relative z-30">
                            ...
                            <div className="w-full p-8">
                                <p className="md:w-80 text-base leading-6  text-gray-600">8 out of 10 professionals are unhappy with their jobs</p>
                        ...
                        <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg mt-3 flex relative z-30">
                            ...
                            <div className="w-full p-8">
                                ...
                                <p className="md:w-80 text-base leading-6 text-gray-600">With the help of our guidance services be in a position of full control of your career dreams. We not only help you choose what&aps;s best for you but also hand hold you to make the outcome occur.</p>
                            </div>
                        </div>
                        <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg mt-3 flex relative z-30">
                            <div className="w-2.5 h-auto bg-indigo-700 rounded-tl-md rounded-bl-md"></div>
                            <div className="w-full p-8">
                                ...
                                <p className="md:w-80 text-base leading-6  text-gray-600">Only 40% professionals get growth in their jobs</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <h1 className="lg:text-5xl md:text-4xl text-2xl font-semibold px-4 leading-10 text-gray-800 mt-6 text-center">What our students says?</h1>
