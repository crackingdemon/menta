    ...
    return (
        <>
            ...
            <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                <p className="font-normal text-sm leading-3 text-indigo-700 hover:text-indigo-800 cursor-pointer pb-2">About Us</p>
                <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                    <div className="w-full lg:w-6/12">
                        <h3 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">WE ARE WORKING SINCE 2011, OUR TEAM MEMBERS ARE FROM TOP IIT's ,IIM's & NIT's alumni offering career counselling to thousands of students in various courses .</h3>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">we are leading towords counselling sessions,seminar,webinars,interviews, students-parents relationships, competitions goals,colleges analysis etc. for young enterpreneurs, students and young mind.we also working with top universities and colleges which offers growing environments to our youth with 5 branches in up including Delhi\Ncr
                        </p>
                    </div>
                    <div className="w-full lg:w-6/12 border-double border-4 border-sky-500 ">
                        <img className="lg:block hidden w-full" src="https://i.ytimg.com/vi/TUQxQM6AMs0/maxresdefault.jpg" alt="people discussing on board" />
                ...
                <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                    <div>
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">Goals 🎯</p>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">We have trained almost 100 plus intern and 50 plus counsellors programmes to improve career counselling awareness among students/guardians/teachers/enterpreneurs.
                        </p>
                    </div>
                    <div>
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">40,000+ Students</p>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">Through our trustworthy system almost 40,000 plus students have counselled themselves  and 5000 plus students taken our personal counselling services which they believe to be the best decision of their lives.
                        </p>
                    </div>
                    <div className="sm:block hidden">
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">35k +User</p>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">We have YouTube channel which has a base of 35k + and still growing on....</p>
                    </div>
                </div>
                ...
                <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                    <div className="w-full lg:w-6/12">
                        ...
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">We organize various programmes for awareness of career counseling , personality development,college selection , educational seminar, workshops in scholls college &universities.
                            We have successfully delivered career counselling seminars to almost 100 plus schools(including icse,isc,cbse,state board schools),50 plus engineering colleges and 20 plus degree colleges in up & uttrakhand .
                        </p>
                        <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">We currently handling,IIT-JEE Aspirants in the menta neeT ug ,gate aspirants menta 2.0 and latests job recruirtment internships through menta jobs.
                            Many students questions,queries are also answered through live discussions and mentorship programmes .we have dedicated support systems to help students in engineering counsellings (josaa,csab,wbjee,upcet,mhcet,reap,uksse,mp,hstes,bitsat,comedk ,tseamcet,various all india&state level counselling medical counselling (all india neet ,upneet ,aaccc, up and state ayush counselling.</p>
                    </div>
                    <div className="w-full lg:w-6/12">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                            ...
                            <div className="flex p-4 shadow-md">
                                ...
                                <div className="">
                                    ...
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">In our team we have one of the top social influencers  having working experience with well known educationists,have done exceptionally well in delivering an informative contents to students/guardians through video , vlogging in youtube channel the menta
                                        .</p>
                                </div>
                            </div>
                            ...
                            <div className="flex p-4 shadow-md">
                                ...
                                <div className="">
                                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Working on</p>
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">We currently handling,IIT-JEE Aspirants in the menta neeT ug ,gate aspirants menta 2.0 and latests job recruirtment internships through menta jobs.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex p-4 shadow-md">
                                ...
                                <div className="">
                                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Contact Us</p>
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">Fell free to contact us anytime for any type of guidance on your Future .</p>
                                </div>
                            </div>
                        </div>
                    </div>
