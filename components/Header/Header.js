...
const Header = () => {
    ...
    return (
        <div className="fixed w-full z-20">
            <nav className="border-b-2 relative px-4 py-4 flex justify-between items-center bg-white">
                <Link href="/">
                ...
                <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
                    ...
                    <li>
                        <Link href="/ourservices">
                            <HomeLinks>OurServices</HomeLinks>
                        </Link>
                    </li>
                    <li className="text-gray-300">
                        <svg
                            ...
                            <ul>
                                ...
                                <li className="mb-1">
                                    <Link href="/ourservices" passHref>
                                        <MobLinks>OurServices</MobLinks>
                                    </Link>
                                </li>
                                <li className="mb-1">
                                    <Link href="/ourvision" passHref>
                                        <MobLinks>OurVision</MobLinks>
                                    </Link>
                                </li>
                                <li className="mb-1">
                                    <Link href="/mentor" passHref>
                                        <MobLinks>Mentor</MobLinks>
                                    </Link>
                                </li>
                            </ul>
                        </div>
