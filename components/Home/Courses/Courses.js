...
const Courses = () => {
  return <>
    <div>
      <h1 className="xl:text-4xl text-3xl text-center text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">Paid Courses</h1>
    </div>
    <div className="min-h-screen rounded-2xl bg-gradient-to-tr from-green-300 to-blue-200 flex justify-center items-center py-20">
